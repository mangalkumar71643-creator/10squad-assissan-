    ...
    <div className="relative h-screen w-screen overflow-hidden text-white select-none flex flex-col"
      ...
      <div className="absolute top-3 right-0 left-0 z-30" style={{ height: "28px" }}>
        ...
        <div
          ...
          style={{ position: "absolute", right: "261px", top: 0, height: "28px", gap: "4px" }}
        >
        ...
        <button
          ...
          <X style={{ width: "12px", height: "12px", color: "#00e5ff" }} />
        </button>
      </div>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div
          ...
          <div
            ...
            style={{ paddingTop: "56px", bottom: 0 }}>
            {characterId3D ? (
