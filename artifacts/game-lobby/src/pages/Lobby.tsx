  ...
  return (
    <div className="h-screen w-screen bg-transparent flex flex-col overflow-hidden text-white font-sans">
      ...
      <div
        ...
        style={{ right: "590px", padding: "0px 10px 8px 10px", background: "rgba(0,0,0,0.25)", clipPath: "polygon(0 0, 100% 0, 100% calc(100% - 18px), calc(100% - 18px) 100%, 18px 100%, 0 calc(100% - 18px))" }}
      >
