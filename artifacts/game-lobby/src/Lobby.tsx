...
// defined further down) and its own starter house (DEFAULT_MAP5_HOUSE),
// not Map 4's. Since the two maps are never
...
// Map 5's starter house — same "only when nothing's been placed or saved
// yet" role as DEFAULT_MAP4_HOUSE above, but a full player-built layout
// (236 walls, 114 crates, 74 drums) instead of a small two-room starter,
// imported wholesale from a set of BACKUP codes the player had already
// saved (map layout + gun/hand pose) so Map 5 ships pre-built instead of
// the blank canvas it started as.
const DEFAULT_MAP5_HOUSE: Map4Item[] = [
  ...
  { kind: "wall", x: 0.46614114752535696, z: 237.95531114077033, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -34.891963814071794, z: 270.1148875005029, axis: "z", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -32.31792651524054, z: 267.5963647420178, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -28.038994758254717, z: 267.596744546769, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -21.33599510311511, z: 267.5996636683485, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -16.327719875638582, z: 267.52625443461915, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -14.121234109691335, z: 270.314499022221, axis: "z", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -39.44198344352236, z: 255.46727824798148, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -32.40531967306718, z: 255.4756956316723, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 5.45780964419025, z: 237.91449402707022, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 9.777095862400754, z: 237.91339923192058, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: -28.213480817577913, z: 255.43432060563467, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 14.617454187771136, z: 237.8520693603152, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 19.60467431059029, z: 237.77849951934152, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 24.696607834897183, z: 237.84044078665627, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 29.24880655004069, z: 237.83498237197736, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 34.26941078431879, z: 237.86899140199793, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 39.31911256482856, z: 237.9113213806086, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 43.409446259588634, z: 237.86402244307428, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 48.3376744905682, z: 237.80250545970569, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 52.98318301266804, z: 237.7625768589776, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 57.93551006732501, z: 237.73174054855926, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 62.45263637882471, z: 237.69772555997207, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 67.30603033414391, z: 237.69597139872903, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 72.32230841270716, z: 237.70488377540167, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 76.96669331110951, z: 237.66330681774053, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 81.44630123271267, z: 237.63245592759603, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 86.34954742006664, z: 237.6825034811422, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 90.54036228946704, z: 237.6577268836615, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 95.20565269814092, z: 237.6394821899236, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 100.16493153860665, z: 237.5957993292883, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 105.17264160727701, z: 237.5785386825753, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 106.64904541072588, z: 240.31785239900034, axis: "z", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 106.61389187528158, z: 244.85452919112356, axis: "z", length: 5, y: 0, color: 0 },
  { kind: "wall", x: 105.87985180839644, z: 246.99714078036038, axis: "x", length: 1, y: 0, color: 0 },
  { kind: "wall", x: -25.613771928171598, z: 238.4166082746221, axis: "x", length: 5, y: 0, color: 0 },
  { kind: "obstacle", x: -23.03483585409113, z: 247.20141606517018, size: 1, rotY: 0.4360627951913513, y: 0 },
  { kind: "obstacle", x: -19.29279593709206, z: 246.24670442675242, size: 1, rotY: 0.9637181723886178, y: 0 },
  { kind: "obstacle", x: -13.007930844870833, z: 244.02074743907872, size: 1, rotY: 1.9258462973886177, y: 0 },
  { kind: "obstacle", x: -8.807433052784889, z: 246.60124139343284, size: 1, rotY: 0.35151690285736764, y: 0 },
  { kind: "obstacle", x: -1.6371330033333091, z: 248.0273362193494, size: 1, rotY: 1.4938515708261173, y: 0 },
  { kind: "obstacle", x: 4.476119693918545, z: 241.7403962070942, size: 1, rotY: 1.9344947348886175, y: 0 },
  { kind: "obstacle", x: 19.658590225889363, z: 248.95597503383598, size: 1, rotY: 1.3790580649667423, y: 0 },
  { kind: "obstacle", x: 19.6455546353917, z: 256.59200185508456, size: 1, rotY: 0.0336802329354925, y: 0 },
  { kind: "obstacle", x: 26.11288879564937, z: 257.9610857644787, size: 1, rotY: 1.5975247153573675, y: 0 },
  { kind: "obstacle", x: 37.16809204510568, z: 253.27782208044505, size: 1, rotY: 1.4864410727792423, y: 0 },
  { kind: "obstacle", x: 47.26642250363832, z: 250.13519162343604, size: 1, rotY: 1.4697875571542425, y: 0 },
  { kind: "obstacle", x: 44.057299904174016, z: 245.58666756755022, size: 1.8, rotY: 5.028237264185494, y: 0 },
  { kind: "obstacle", x: 41.802454680632756, z: 243.13180239487718, size: 1.8, rotY: 3.4853797446542445, y: 0 },
  { kind: "obstacle", x: 32.977865870411044, z: 242.06636148514053, size: 1.8, rotY: 5.269386287622992, y: 0 },
  { kind: "obstacle", x: 27.438637729496794, z: 241.53362113951263, size: 1.8, rotY: 3.976472566919867, y: 0 },
  { kind: "obstacle", x: 12.112621468726328, z: 248.91126014311587, size: 1.8, rotY: 5.436017684107366, y: 0 },
  { kind: "obstacle", x: 0.8488783160663207, z: 256.54393320577225, size: 1.8, rotY: 4.91699673684174, y: 0 },
  { kind: "obstacle", x: -9.890862481472778, z: 256.5548194824511, size: 1.8, rotY: 4.12891050637299, y: 0 },
  { kind: "obstacle", x: -17.994304240404816, z: 253.87743763182675, size: 1.8, rotY: -2.451078482884822, y: 0 },
  { kind: "obstacle", x: -27.40860831591175, z: 250.803816867263, size: 1.8, rotY: -1.899346402806697, y: 0 },
  { kind: "obstacle", x: -39.50488068743824, z: 260.51942189360426, size: 1.8, rotY: -0.613836588353572, y: 0 },
  { kind: "obstacle", x: -37.831031455572955, z: 268.4630812957856, size: 1, rotY: -0.690364713353572, y: 0 },
  { kind: "obstacle", x: -21.519823710623832, z: 282.4245808092501, size: 1, rotY: 0.7303837241464284, y: 0 },
  { kind: "obstacle", x: -13.320845228137918, z: 287.04068800125566, size: 1, rotY: 0.819246419458929, y: 0 },
  { kind: "obstacle", x: -19.193508339150533, z: 282.5453762730055, size: 1, rotY: 5.4644896323495535, y: 0 },
  { kind: "obstacle", x: -25.264925239584453, z: 287.3419809521866, size: 1, rotY: 4.934983772974554, y: 0 },
  { kind: "obstacle", x: -33.541070066125904, z: 288.2669523170471, size: 1, rotY: 4.527054378443303, y: 0 },
  { kind: "obstacle", x: -32.5616644487571, z: 294.66513018234104, size: 1, rotY: 6.766047835474554, y: 0 },
  { kind: "obstacle", x: -22.608187644655985, z: 297.0787966260798, size: 1, rotY: 7.595506819849553, y: 0 },
  { kind: "obstacle", x: -17.279842284673247, z: 292.848578080537, size: 1, rotY: 8.563798274927679, y: 0 },
  { kind: "obstacle", x: -8.173914916711364, z: 292.5547170305852, size: 1, rotY: 8.37309495461518, y: 0 },
  { kind: "obstacle", x: -0.07537065499494355, z: 289.42334977703405, size: 1, rotY: 7.64795247414643, y: 0 },
  { kind: "obstacle", x: -2.9191701147461355, z: 282.3793827135536, size: 1.8, rotY: 10.928066524439402, y: 0 },
  { kind: "obstacle", x: 3.6925476825110026, z: 278.01185832459925, size: 1.8, rotY: 8.516883303003855, y: 0 },
  { kind: "obstacle", x: 6.939270233178194, z: 270.3063610142083, size: 1.8, rotY: 8.448999660425732, y: 0 },
  { kind: "obstacle", x: 21.445354364621153, z: 270.994710307436, size: 1.8, rotY: 8.186328420191359, y: 0 },
  { kind: "obstacle", x: 38.50870229779511, z: 269.1495995019021, size: 1.8, rotY: 7.79567876198823, y: 0 },
  { kind: "obstacle", x: 51.319783132668185, z: 271.51408097491617, size: 1.8, rotY: 6.941550636988231, y: 0 },
  { kind: "obstacle", x: 69.7811393842596, z: 270.93586571700433, size: 1.8, rotY: 8.137570217066354, y: 0 },
  { kind: "obstacle", x: 71.54481173641588, z: 262.8087895859404, size: 1.8, rotY: 9.017619924097605, y: 0 },
  { kind: "obstacle", x: 90.61355504328753, z: 270.9032841900543, size: 1.8, rotY: 7.607442092066352, y: 0 },
  { kind: "obstacle", x: 94.88238212284769, z: 257.8102362834252, size: 1.8, rotY: 9.733758010035102, y: 0 },
  { kind: "obstacle", x: 84.27678405304846, z: 250.27548895848452, size: 1.8, rotY: 9.884950099878855, y: 0 },
  { kind: "obstacle", x: 77.38041367628536, z: 247.0941017582069, size: 1.8, rotY: 9.950364455347609, y: 0 },
  { kind: "obstacle", x: 70.50074075246323, z: 249.63223223111683, size: 1.8, rotY: 11.364857277613233, y: 0 },
  { kind: "obstacle", x: 68.8489777366381, z: 247.06421837710266, size: 1.8, rotY: 9.396169679956982, y: 0 },
  { kind: "obstacle", x: 62.23058213827607, z: 249.1211897166904, size: 1.8, rotY: 11.333381447535107, y: 0 },
  { kind: "obstacle", x: 59.87212794912748, z: 258.3667489091784, size: 1.8, rotY: 12.236270412378857, y: 0 },
  { kind: "obstacle", x: 53.845040160472855, z: 256.5146655659676, size: 1.8, rotY: 10.818697902613232, y: 0 },
  { kind: "drum", x: 49.317731461022724, z: 257.15893358655916, rotY: 7.639169728785109, y: 0 },
  { kind: "drum", x: 53.46593808756589, z: 249.66916722311814, rotY: 8.678229396753862, y: 0 },
  { kind: "drum", x: 61.79624403420518, z: 245.85247564764074, rotY: 8.490614992456987, y: 0 },
  { kind: "drum", x: 70.02947250541217, z: 244.24378881848406, rotY: 8.16229341042574, y: 0 },
  { kind: "drum", x: 78.10581092603924, z: 243.68044067038085, rotY: 8.16229341042574, y: 0 },
  { kind: "drum", x: 88.08954577951548, z: 245.27639133024755, rotY: 7.764855519800738, y: 0 },
  { kind: "drum", x: 95.87012475608338, z: 243.70972682277628, rotY: 8.450498635035116, y: 0 },
  { kind: "drum", x: 104.5821803589331, z: 240.538541472629, rotY: 8.450498635035116, y: 0 },
  { kind: "drum", x: 90.14554226878643, z: 241.45475010148766, rotY: 4.690871736841755, y: 0 },
  { kind: "drum", x: 73.48188973619598, z: 241.51602648343479, rotY: 4.552012898951131, y: 0 },
  { kind: "drum", x: 51.51260606340694, z: 261.7414532347946, rotY: 5.433908309107383, y: 0 },
  { kind: "drum", x: 54.7540986575802, z: 280.31951942562955, rotY: 6.570094148951136, y: 0 },
  { kind: "drum", x: 12.865542839114909, z: 282.7549178900642, rotY: 32.52309927590421, y: 0 },
  { kind: "obstacle", x: 15.623892677714032, z: 278.52638617668396, size: 1.8, rotY: 33.79010064309172, y: 0 },
  { kind: "obstacle", x: 6.805863938788949, z: 283.87783018833954, size: 1.8, rotY: 36.62408286965422, y: 0 },
  { kind: "obstacle", x: 17.18687462388687, z: 286.4081944076717, size: 1.8, rotY: 39.52589336770109, y: 0 },
  { kind: "obstacle", x: 16.621408493834885, z: 281.0653862522873, size: 1, rotY: 40.684886824732345, y: 0 },
  { kind: "obstacle", x: 11.689349734389763, z: 282.32716476838715, size: 1, rotY: 43.758882967310456, y: 0 },
  { kind: "obstacle", x: 12.14049565258419, z: 295.1796635446641, size: 1, rotY: 44.27604766457607, y: 0 },
  { kind: "obstacle", x: 16.201943006988728, z: 300.6614318591491, size: 1, rotY: 45.05549600441982, y: 0 },
  { kind: "obstacle", x: 19.37076937486112, z: 306.9435839142591, size: 1, rotY: 44.60251299660733, y: 0 },
  { kind: "obstacle", x: 21.567110002268343, z: 313.67224320134216, size: 1, rotY: 44.56216328957608, y: 0 },
  { kind: "obstacle", x: 24.068535880379873, z: 319.88223370829394, size: 1, rotY: 44.667697957544824, y: 0 },
  { kind: "obstacle", x: 23.308352170136605, z: 327.4108783152921, size: 1, rotY: 43.8975031821542, y: 0 },
  { kind: "obstacle", x: 15.680090060253027, z: 328.72760051051074, size: 1, rotY: 42.34600381691981, y: 0 },
  { kind: "obstacle", x: 11.905919617813442, z: 323.6882563384543, size: 1, rotY: 41.62703257668543, y: 0 },
  { kind: "obstacle", x: 5.197741978149367, z: 317.07478998142926, size: 1, rotY: 41.59308614113854, y: 0 },
  { kind: "obstacle", x: 3.3965949420252857, z: 310.06691108054, size: 1, rotY: 41.2598286216073, y: 0 },
  { kind: "obstacle", x: 9.67076614231088, z: 305.36633584153066, size: 1, rotY: 39.59230703957606, y: 0 },
  { kind: "obstacle", x: 24.704986308594297, z: 295.5558793848318, size: 1, rotY: 39.953971248560414, y: 0 },
  { kind: "obstacle", x: 24.792302013617068, z: 309.0487343362334, size: 1, rotY: 44.717814070826044, y: 0 },
  { kind: "obstacle", x: 55.353457034627915, z: 298.6163819613549, size: 1, rotY: 46.267466414576035, y: 0 },
  { kind: "obstacle", x: 66.39095073438034, z: 287.3174791653361, size: 1, rotY: 52.10637725441977, y: 0 },
  { kind: "obstacle", x: 83.69920410452897, z: 288.1029787805841, size: 1, rotY: 52.0020778891854, y: 0 },
  { kind: "obstacle", x: 79.31431311123444, z: 277.41053831801264, size: 1, rotY: 53.68564258645102, y: 0 },
  { kind: "obstacle", x: 79.9235111666211, z: 293.3775074448408, size: 1, rotY: 56.24683911965416, y: 0 },
  { kind: "obstacle", x: 69.37261888606177, z: 291.02770272686917, size: 1, rotY: 55.33716983254481, y: 0 },
  { kind: "obstacle", x: 62.56659978730991, z: 288.2289421517191, size: 1, rotY: 54.62930577004481, y: 0 },
  { kind: "obstacle", x: 72.86869216153997, z: 285.1931392983512, size: 1.8, rotY: 58.310568563013526, y: 0 },
  { kind: "obstacle", x: 63.42367144501837, z: 282.2009048894355, size: 1.8, rotY: 61.106844393091656, y: 0 },
  { kind: "obstacle", x: 51.264010925100216, z: 284.4301098948692, size: 1.8, rotY: 59.38131104348229, y: 0 },
  { kind: "obstacle", x: 68.99247916887718, z: 289.7278286829411, size: 1.8, rotY: 57.75884439309169, y: 0 },
  { kind: "obstacle", x: 83.62397326315087, z: 288.12750154681476, size: 1.8, rotY: 58.06123911965418, y: 0 },
  { kind: "obstacle", x: 94.07347175085542, z: 265.05305668200197, size: 1, rotY: 57.899972127466725, y: 0 },
  { kind: "obstacle", x: 96.99765129145865, z: 268.53744933565275, size: 1, rotY: 57.69693555520111, y: 0 },
  { kind: "obstacle", x: 98.50297395809957, z: 263.9753525673906, size: 1, rotY: 60.514200984888596, y: 0 },
  { kind: "obstacle", x: 98.13864287764716, z: 254.98933989516726, size: 1, rotY: 59.688465047388604, y: 0 },
  { kind: "obstacle", x: 104.6237961304528, z: 248.8518837412329, size: 1, rotY: 58.605377449732345, y: 0 },
  { kind: "obstacle", x: 96.36490035962471, z: 261.6781136285249, size: 1, rotY: 56.18062056496673, y: 0 },
  { kind: "drum", x: 87.92380872981917, z: 259.88697888091116, rotY: 50.85131890481046, y: 0 },
  { kind: "drum", x: 92.8033603360716, z: 267.53661672815423, rotY: 50.85131890481046, y: 0 },
  { kind: "drum", x: 100.25222700405226, z: 264.00471329325455, rotY: 52.541667879419826, y: 0 },
  { kind: "drum", x: 101.59511986321672, z: 255.12078409369204, rotY: 53.27606787941982, y: 0 },
  { kind: "drum", x: 93.7661923687307, z: 248.6640018674016, rotY: 53.7796561118417, y: 0 },
  { kind: "drum", x: 81.19350279261751, z: 279.8678494320584, rotY: 56.3359602134042, y: 0 },
  { kind: "drum", x: 70.27940074425544, z: 279.7803708602671, rotY: 54.96466739113858, y: 0 },
  { kind: "drum", x: 63.341403703437976, z: 278.01775446356123, rotY: 55.13869742043546, y: 0 },
  { kind: "drum", x: 50.906895002615066, z: 291.39922773370176, rotY: 55.829287020044845, y: 0 },
  { kind: "drum", x: 72.13265358471924, z: 265.25772143745934, rotY: 61.19721924660735, y: 0 },
  { kind: "drum", x: 68.43460050796965, z: 270.0810747285439, rotY: 62.08405454934172, y: 0 },
  { kind: "drum", x: 69.00820955872673, z: 260.97611171587994, rotY: 65.93750694191979, y: 0 },
  { kind: "drum", x: 63.9016018770785, z: 260.626703463919, rotY: 68.0950442466073, y: 0 },
  { kind: "drum", x: 80.09693810552525, z: 258.9292021535113, rotY: 70.77097364113855, y: 0 },
  { kind: "obstacle", x: 75.67495200910584, z: 267.1552320295901, size: 1, rotY: 68.23513311379484, y: 0 },
  { kind: "obstacle", x: 66.14451378083346, z: 266.23143413722545, size: 1, rotY: 67.0150363364511, y: 0 },
  { kind: "obstacle", x: 68.2204783857836, z: 256.81006828374075, size: 1, rotY: 65.388862459498, y: 0 },
  { kind: "obstacle", x: 75.39386458048179, z: 259.10379045029873, size: 1, rotY: 64.66309903176364, y: 0 },
  { kind: "obstacle", x: 79.90333508151794, z: 267.80569305237884, size: 1, rotY: 64.00460620949801, y: 0 },
];
    ...
    return legacyParsed
      ...
      .map(
        (w): Map4Wall => ({
          ...
          z: w.z,
          axis: w.axis,
          length: typeof w.length === "number" ? w.length : MAP4_WALL_LENGTH_DEFAULT,
        }),
      );
  } catch {
    return [];
...
// toggleReferencePose (the fixed 1m preview spot below), so both always
// scale the gun identically regardless of which one last touched it.
const GUN_RAW_LENGTH = 1329.79;
// REFERENCE POSE's fixed parking spot for the gun — straight out in front
// of the root at roughly chest height, at a clean, known 1m distance
// rather than wherever the calibrated grip happens to have it (see
// toggleReferencePose) — meant purely as a side-by-side visual reference
...
function loadGunGripRotation(): THREE.Euler {
  try {
    ...
    if (!raw) return new THREE.Euler(GUN_GRIP_ROTATION_DEFAULT.x, GUN_GRIP_ROTATION_DEFAULT.y, GUN_GRIP_ROTATION_DEFAULT.z, "XYZ");
    const parsed = JSON.parse(raw);
    return new THREE.Euler(
      typeof parsed.x === "number" ? parsed.x : GUN_GRIP_ROTATION_DEFAULT.x,
      typeof parsed.y === "number" ? parsed.y : GUN_GRIP_ROTATION_DEFAULT.y,
      typeof parsed.z === "number" ? parsed.z : GUN_GRIP_ROTATION_DEFAULT.z,
      "XYZ",
    );
  } catch {
    return new THREE.Euler(GUN_GRIP_ROTATION_DEFAULT.x, GUN_GRIP_ROTATION_DEFAULT.y, GUN_GRIP_ROTATION_DEFAULT.z, "XYZ");
  }
}
...
// `scale` param, now finger-keyed) so each finger's own 3 joints curl or
// loosen together proportionally, without needing all 15 individual
// joints controlled by hand. Rotations around a fixed axis compose by
// simple angle addition regardless of order, so accumulating a finger's
// scale across many nudge taps and applying it in one shot (equip time)
// or incrementally (live nudge) always lands on the exact same final
// pose either way.
const FINGER_NAMES = ["Thumb", "Index", "Middle", "Ring", "Pinky"] as const;
type FingerName = (typeof FINGER_NAMES)[number];
type FingerCurlExtra = Record<FingerName, number>;
...
function loadFingerCurlExtras(): { right: FingerCurlExtra; left: FingerCurlExtra } {
  ...
  try {
    const raw = localStorage.getItem(GUN_FINGER_CURL_STORAGE_KEY);
    if (!raw) return fallback;
    const parsed = JSON.parse(raw);
    for (const side of ["right", "left"] as const) {
      for (const finger of FINGER_NAMES) {
        const v = parsed?.[side]?.[finger];
        if (typeof v === "number") fallback[side][finger] = v;
      }
    }
    return fallback;
  } catch {
...
const fingerCurlExtras = loadFingerCurlExtras();
...
function updateOffHandReach(rig: FighterRig) {
  ...
  // the target itself no longer comes from the gun object at all.
  if (!rig.gun || !rig.rightHand || !rig.leftArm || !rig.leftForeArm || !rig.leftHand) return;
  calibratedGripWorldMatrix(rig.rightHand, offHandGripMatrix);
  const foregripWorld = GUN_OFFHAND_TARGET_LOCAL.clone().applyMatrix4(offHandGripMatrix);
...
// curl) lets the PLAYER tab's per-finger nudges add or remove curl on
// top of this base table proportionally — either one number applied to
// every joint at once (the base call), or a FingerCurlExtra map giving
// each finger (by its own name, joint number stripped) its own
// independent scale. Every joint rotates about the SAME fixed axis, so
// calling this multiple times with small scales and calling it once
// with their sum produces the identical final pose (rotations about one
...
interface FighterRig {
  ...
  // A second, calmer idle (IdleBreathing — arms relaxed at the sides,
...
function loadPlayerCharacter(scene: THREE.Scene, onLoaded: (rig: FighterRig) => void) {
  Promise.all([new GLTFLoader().loadAsync("/characters/player.glb"), loadSourceRigData()])
    .then(([gltf, source]) => {
      ...
      let naturalIdleAction: THREE.AnimationAction | null = null;
      ...
      // A second, always-bound action for the calmer arms-at-the-sides
      // clip — kept separate from idleAction (which is RifleIdle, chosen
      // as the default above) purely so the GUN tab's REFERENCE POSE
      // toggle has something to crossfade to that shows the body's actual
      // natural stance instead of the pre-bent two-handed grip pose.
      const naturalClip = source.clips.get("IdleBreathing");
      if (naturalClip) {
        naturalIdleAction = mixer.clipAction(retargetClip(naturalClip, source.rest, restPlayer, posRatio));
        naturalIdleAction.play();
        naturalIdleAction.setEffectiveWeight(0);
      }
...
function CombatArena({
  ...
  const activeBuildDefaultItems = mapId === 5 ? DEFAULT_MAP5_HOUSE : DEFAULT_MAP4_HOUSE;
  ...
  // into the close-up orbit view, selecting MAP/RIGHT/LEFT switches back
  ...
  useEffect(() => {
    ...
    // above, alongside the room crates.
      ...
      Promise.all([loadCrateMaterial(), loadDrumMaterial()]).then(([crateMaterial, drumMaterial]) => {
        ...
        buildModeRef.current = {
          ...
          // sides) instead of the two-handed RifleIdle stance, so both
          // the gun and the body's real shape are visible on their own,
          // side by side, uncombined.
          toggleReferencePose: () => {
            if (!player) return;
            if (!referencePoseOn) {
              if (player.gun && !gunDetached) {
              ...
              gunDetached = false;
              player.naturalIdleAction?.setEffectiveWeight(0);
          ...
          // damage, no camera-snap-to-facing, no vibration. Map 4/5 have
          // no bots to hit anyway; this exists purely so a calibrated grip
          // can be checked against what it looks like mid-recoil, not just
          // standing still.
          triggerFirePreview: () => {
            if (!player) return;
            playerFireT = 0;
    ...
    // in front of the player (not tracking the calibrated grip at all)
    // and crossfades to the natural, arms-relaxed idle (naturalIdleAction)
    ...
    const tick = () => {
      ...
      if (player && playerDeathT < 0) {
        if (referencePoseOn) {
          // Neither reaching (updateOffHandReach — there's nothing on the
          // hand to reach for right now) nor frozen (applyOffHandFreeze —
          // that would hold whatever bent pose was last active, not the
          // relaxed one naturalIdleAction is meant to show): left
          // entirely alone so naturalIdleAction's own baked arm pose
          // shows through undisturbed, same reasoning as skipping
          // updateDetachedGunAnchor here — the gun's fixed 1m spot (see
          // toggleReferencePose) isn't meant to track anything either.
        } else if (gunDetached) {
      ...
      {(mapId === 4 || mapId === 5) && buildTopTab === "gun" && (
        <>
          ...
          >
            ...
            {/* REFERENCE POSE — parks the gun a fixed 1m out in front
                (not the calibrated grip position) and shows the body in
            ...
            <button
              ...
              style={{
                padding: "8px 18px",
                borderRadius: 6,
                background: referencePoseOnUI ? "rgba(255,190,90,0.3)" : "rgba(255,255,255,0.1)",
                border: referencePoseOnUI ? "1px solid rgba(255,215,150,0.8)" : "1px solid rgba(200,220,240,0.4)",
                color: "#dce8f5",
                fontFamily: "'Rajdhani', sans-serif",
                fontWeight: 700,
                letterSpacing: "0.06em",
            ...
            >
              {referencePoseOnUI ? "🧍 REFERENCE: ON" : "🧍 REFERENCE POSE"}
            </button>
